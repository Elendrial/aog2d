...
This is written entirely in java by myself, and uses my RPGEngine as a base. An estimated 17% of the 'core' is done.
(may find I need to port to Gridbased Engine if RPGEngine is too buggy/barebones)
